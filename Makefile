# Streaming - Generic, reusable Go module for streaming and transport abstractions.
# Module: digital.vasic.streaming
...
challenge:
	../challenges/scripts/streaming_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Streaming - Generic, reusable Go module for streaming and transport abstractions."
	@echo ""
	@echo "Build & Test:"
